...
import {DropdownToggle, DropdownMenu, Dropdown, Input, FormGroup, Button} from 'reactstrap';
...
import SaveThemeSettings from "Components/ThemeOptions/SaveThemeSettings";
...
class ThemeOptions extends Component {
     ...
     */
    toggleThemePanel() {
        if (!this.state.saveSettingsPanelOpened) {
            this.setState({
    ...
    saveSettingsPanelOpened() {
        this.setState({
            saveSettingsPanelOpened: true
        });
    }

    saveSettingsPanelClosed() {
        this.setState({
            saveSettingsPanelOpened: false
        });
    }
        ...
        return (
            <div className="fixed-plugin">
                ...
                <Dropdown isOpen={this.state.themeOptionPanelOpen} toggle={() => this.toggleThemePanel()}>
                    ...
                    <DropdownMenu>
                        <Scrollbars className="rct-scroll" autoHeight autoHeightMin={100} autoHeightMax={530} autoHide
                                    autoHideDuration={100}>
                            <ul className="list-unstyled text-center mb-0">
                                <li className="header-title mb-10">
                                    <IntlMessages id="themeOptions.themeLayout"/>
                                </li>
                                <li className="adjustments-line mb-10 ml-30 mr-30">
                                    <IntlMessages id="themeOptions.layoutSidebar"/>
                                    <FormControlLabel
                                        className="m-0"
                                        control={
                                            <Switch
                                    ...
                                    />
                                    <IntlMessages id="themeOptions.layoutHorizontal"/>
                                </li>
                                <li className="header-title mb-10">
                                ...
                                {!horizontalLayout && enableSidebarBackgroundImage &&
                                <li className="background-img">
                                    {sidebarBackgroundImages.map((sidebarImage, key) => (
                                        <a className={classnames('img-holder', {'active': selectedSidebarImage === sidebarImage})}
                                           href="#" key={key} onClick={(e) => this.setSidebarBgImage(sidebarImage, e)}>
                                            <img src={sidebarImage} alt="sidebar" className="img-fluid" width=""
                                                 height=""/>
                                        </a>
                                    ))}
                                </li>
                            ...
                            <ul className="list-unstyled mb-0 p-10 app-settings">
                                <li className="header-title mb-10">
                                    <SaveThemeSettings onClick={this.saveSettingsPanelOpened.bind(this)}
                                                       onClose={this.saveSettingsPanelClosed.bind(this)}/>
                                </li>
                            </ul>
                        </Scrollbars>
                    </DropdownMenu>
